...
public class ImageLoader {
    ...
    public static void loadResources(){
        ...
        animations.put("fire", loadAnimation("fire", 1, 1, 2, false));
    }
    ...
    public static Animation getAnimation(String path){
        ...
        switch (path){
            ...
            case "fire" -> animation = new Animation(animations.get(path), 0.25);
            default -> {
                ...
                if(!animations.containsKey(path)){
                    switch (path){
                        ...
                        case "bomb", "endkey", "key", "coin", "coin3", "heart" ->
                        ...
                        case "heart3" -> animations.put(path, loadAnimation(path, 1.5, 1.5, true));
                        case "heart5" -> animations.put(path, loadAnimation(path, 2, 2, true));
                        case "enemy", "player" -> animations.put(path, loadAnimation(path, 0.8, 0.8,  false));
                        case "throw", "drop", "self_destruct" -> animations.put(path, loadAnimation("blank", 1.0/Constants.tileSize, 1.0/Constants.tileSize,  false));
//                        case "wall", "tile", "enemy", "player" -> animations.put(path, loadAnimation(path, 1, 1, 1, false));
    ...
    public static ImageIcon getIcon(String path){
        ...
        if(!icons.containsKey(path)){
            switch (path){
                case "bomb" -> icons.put(path, loadIcon(path, Constants.iconSize, Constants.iconSize*0.5));
                ...
                default -> icons.put(path, loadIcon(path, Constants.iconSize, Constants.iconSize));
            }
        }
        icon = icons.get(path);
        return icon;
